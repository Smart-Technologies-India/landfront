...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
    ...
    const village = await ApiCall({
      ...
      `,
        veriables: {
            id: parseInt(data.data.getSaleById.village_id)
        },
    });
    ...
    const subdivision = await ApiCall({
      ...
      `,
        veriables: {
            searchSurveyInput: {
                villageId: parseInt(data.data.getSaleById.village_id),
                survey_no: data.data.getSaleById.survey_no,
            }
        },
    });
    ...
    return json({
        user: cookie,
        from_data: data.data.getSaleById,
...
const SaleView: React.FC = (): JSX.Element => {
